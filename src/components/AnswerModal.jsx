    ...
    return (
        <div className="fixed inset-0 z-50 backdrop-blur-sm bg-white/30 flex justify-center items-center">
            <div className="bg-white rounded-2xl p-6 w-[90%] md:w-1/3 shadow-xl space-y-4 relative">
                ...
                {/* Textarea */}
                <textarea
                    className={`w-full border ${isAnswerEmpty ? 'border-red-400' : 'border-rose-300'} rounded-lg p-3 text-base focus:outline-none focus:ring-2 ${isAnswerEmpty ? 'focus:ring-red-400' : 'focus:ring-rose-400'}`}
                    rows={5}
                ...
                <div className="text-center pt-2">
                    <button
                        ...
                        className={`py-2 px-6 rounded-full shadow-md transition transform ${isAnswerEmpty
